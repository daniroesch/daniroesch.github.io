...
.ui-btn:hover { color: #000; font-weight: 600; }
...
body.fit-width #home-btn { top: -2.5em; right: 0; left: auto; }
body.fit-width #fullscreen-btn { bottom: -2.5em; left: 0; right: auto; }

body.fit-height #home-btn { top: 10px; right: -5.5em; left: auto; }
body.fit-height #fullscreen-btn { bottom: 10px; left: -5.5em; right: auto; }
...
h1:hover { color: #000; font-weight: 800; }
...
.bracket { font-weight: 300; }

.menu-links { flex-grow: 1; text-align: center; text-transform: lowercase; padding: 0 0.6em; }
.menu-links a { color: #888; text-decoration: none; transition: color 0.2s; font-weight: 300; }
.menu-links a:hover, .menu-links a.active { color: #000; font-weight: 600; }
...
.legal-links a { 
    color: #a0a0a0; 
    text-decoration: none; 
    transition: color 0.2s, font-weight 0.2s ease; 
    font-weight: 300; 
}

.legal-links a:hover { color: #000; font-weight: 600; }
...
#loading a { color: #888; font-weight: 300; text-decoration: none; transition: color 0.2s, font-weight 0.2s ease; }
#loading a:hover { color: #000; font-weight: 600; }

/* NEU: Zwingt die unsichtbaren Hilfs-Seiten des Plugins dazu, transparent zu sein */
.st-page-flip { background-color: transparent !important; }
.st-page { background-color: transparent !important; }

/* Die Seite selbst ist durchsichtig, nur das Bild bekommt den weißen Hintergrund! */
.page { background-color: transparent !important; position: relative; }
.page img { 
    background-color: #ffffff; /* Der weiße Hintergrund liegt jetzt HINTER dem Bild */
    width: 100%; 
    height: 100%; 
    object-fit: cover; 
...
.grid-header h2 { font-weight: 600; font-size: 1.5rem; text-transform: lowercase; }
.grid-header a { color: #000; text-decoration: none; font-weight: 600; text-transform: lowercase; font-size: 1.5rem; }
