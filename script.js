...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadBook(bookName, lang, initialPage = 0) {
        ...
        if (cover.exists) { 
            ...
            // Fallback für die Sicherheit, falls ein Bild die Maße nicht meldet
    ...
    function buildBook(imageUrls, folder, width, height, initialPage = 0) {
        ...
        // SICHERHEITSNETZ (try-catch) falls das Buch-Plugin mal hakt
        try {
    ...
    document.addEventListener('click', (e) => {
        ...
        if (e.target.closest('#fullscreen-btn')) { e.preventDefault(); toggleFullscreen(); }
    });
