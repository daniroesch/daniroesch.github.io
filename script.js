document.addEventListener('DOMContentLoaded', () => {
    ...
    // NEU: Asynchrone Vollbild-Funktion mit Querformat-Erzwingung (Landscape Lock)
    async function toggleFullscreen() {
        ...
        try {
            if (!document.fullscreenElement && !document.webkitFullscreenElement && !document.msFullscreenElement) {
                ...
                // Sobald wir im Vollbild sind: Versuchen, das Handy ins Querformat zu zwingen
                if (screen.orientation && screen.orientation.lock) {
                    try {
                        await screen.orientation.lock('landscape');
                    } catch (err) {
                        // Wird von iOS Safari ignoriert, wirft hier einen "stummen" Fehler, 
                        // aber das Vollbild bleibt trotzdem erhalten!
                        console.log("Auto-Querformat wird vom Browser blockiert.");
                    }
                }
            } else {
                // Vollbild beenden
                ...
                // Bildschirmsperre wieder aufheben
